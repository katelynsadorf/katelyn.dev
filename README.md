...
```bash
$ git clone https://github.com/katelynsadorf/katelynsadorf.com.git
$ cd katelynsadorf.com
$ npm install
$ npm run dev
```
...
Licensed under the [MIT license](https://github.com/katelynsadorf/katelynsadorf.com/blob/main/LICENSE).
